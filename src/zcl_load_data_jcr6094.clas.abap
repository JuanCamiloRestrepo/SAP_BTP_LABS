CLASS zcl_load_data_jcr6094 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data: lt_acc_categ    type table of ztb_acc_categ_jr,
          lt_catego    type table of ztb_catego_jcr6,
          lt_clientes  type table of ztb_clientes_jcr,
          lt_clnts_lib type table of ztb_clnts_lib_jr,
          lt_libros    type table of ztb_libros_jcr6.
...
******** TABLA1 ********
    ...
    delete from ztb_acc_categ_jr.
    insert ztb_acc_categ_jr from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_jcr6.
    insert ztb_catego_jcr6 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_jcr.
    insert ztb_clientes_jcr from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_jr.
    insert ztb_clnts_lib_jr from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_jcr6.
    insert ztb_libros_jcr6 from table @lt_libros.
